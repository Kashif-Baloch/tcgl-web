...
export function SignatureStep({ onNext, onBack }: Props) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-4">
                <div className="text-center">
                    <h3 className="text-xl font-ubuntu font-semibold">Digital Signature</h3>
                    <p className="text-muted-foreground font-ubuntu">Please sign in the box below using your mouse or touch</p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex justify-end">
                        <Button type="button" variant="outline" size="sm" className="h-[40px] cursor-pointer" onClick={clearSignature}>
                            Clear Signature
                            <X />
                        </Button>
                    </div>
            ...
            <div className="flex items-center w-full relative gap-2">
                ...
                <Button type="submit" disabled={!hasSignature} className="relative bg-gradient-to-r w-full flex-1 cursor-pointer h-[50px]  text-white  rounded-md  from-[#d73470] to-primary hover:from-[#1F8585] hover:to-[#d73470] !text-lg transition duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed">
                    Next
