...
const schema = z.object({
    drivingLicenceFront: z.instanceof(File, { message: "Please upload the front of your driving licence" }),
    drivingLicenceBack: z.instanceof(File, { message: "Please upload the back of your driving licence" }),
})
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-6">
                <div className="text-center">
                    <h3 className="text-xl font-ubuntu font-semibold">Upload Driving Licence</h3>
                    <p className="text-muted-foreground font-ubuntu">Please upload both sides of your driving licence</p>
                </div>
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        />
                        {errors.drivingLicenceFront && <p className="text-sm text-red-600">{errors.drivingLicenceFront.message}</p>}
                    </div>

                    {frontPreview && (
                        <Card>
                            <CardContent className="px-4">
                                <p className="font-ubuntu text-sm sm:text-base font-medium mb-2">Front Side Preview:</p>
                                <img
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="py-2.5 h-[50px] !px-5"
                        />
                        {errors.drivingLicenceBack && <p className="text-sm text-red-600">{errors.drivingLicenceBack.message}</p>}
                    </div>

                    {backPreview && (
                        <Card>
                            <CardContent className="px-4">
                                <p className="font-ubuntu text-sm sm:text-base font-medium mb-2">Back Side Preview:</p>
                                <img
                ...
                {frontPreview && backPreview && (
                    <Card>
                        <CardContent className="px-4">
                            <p className="text-base sm:text-lg font-ubuntu font-medium mb-4">Both Sides Uploaded:</p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <p className="font-ubuntu text-sm sm:text-base text-muted-foreground mb-1">Front</p>
                                    <img
                                        src={frontPreview || "/placeholder.svg"}
                                        alt="Driving licence front"
                                ...
                                <div>
                                    <p className="font-ubuntu text-sm sm:text-base text-muted-foreground mb-1">Back</p>
                                    <img
                                        src={backPreview || "/placeholder.svg"}
                                        alt="Driving licence back"
                                        className="w-full h-[150px] object-contain border rounded py-2"
            ...
            <div className="flex items-center w-full relative gap-2">
                ...
                <Button type="submit" disabled={!frontFile || !backFile} className="relative bg-gradient-to-r w-full flex-1 cursor-pointer h-[50px]  text-white  rounded-md  from-[#d73470] to-primary hover:from-[#1F8585] hover:to-[#d73470] !text-lg transition duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed">
                    Next
