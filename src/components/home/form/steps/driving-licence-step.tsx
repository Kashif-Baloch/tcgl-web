    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center w-full relative gap-2">
                ...
                <Button type="submit" disabled={!frontFile || !backFile} className="relative bg-gradient-to-r w-full flex-1 cursor-pointer h-[50px] from-[#239696] to-[#33CCCC] text-white  rounded-md  hover:from-[#1F8585] hover:to-[#2BBBBB] !text-lg transition duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed">
                    Next
